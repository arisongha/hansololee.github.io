...
이해를 높이기 위하여 위 예시를 구현한 python code인 `min-char-rnn.py`를 살펴보겠습니다. 이는 cs231n강의의 <a href="https://gist.github.com/karpathy/d4dee566867f8291f086">Karpathy의 Gist</a>에서 가져왔습니다.
